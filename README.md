# Contents
1. AiAgentsLangGraph.ipynb - Creating a basic agent from scratch
2. DefiningALangGraph.ipynb - Creating a LangGraph workflow with Agent state and Tavily search tool
